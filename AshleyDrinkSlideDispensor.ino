...
//Stepper Motors Max Bounds Setup
const int Slide_stepdelay = 1;
const int Slide_maxSteps = 500;

const int Dispense_stepdelay = 1;
...
const int DrinkPositions_Max = 7;
...
int Recipy[DrinkChoice_Max][5] = { {2, 5, 5, 5, 0}, {1, 5, 5, 5, 0}, {1, 2, 5, 5, 5}, {3, 4, 4, 4, 0}, {1, 5, 6, 6, 6} };

double BottleLocations[DrinkPositions_Max] = { 0.0, 8.0, 16.0, 24.0, 32.0, 40.0, 48.0 }; //6, 14, 22, 30, 38, 46, 
...
void DispenseMovetoHome() {
  ...
  while (digitalRead(Slide_HomeLimitPin)); //Do while not at Home
...
void SlideMovetoHome() {
  ...
  //set offset to ultrasonic value and real distance to 0
  DistanceCm_Offset = DistanceCm;
  DistanceCm = 0;
